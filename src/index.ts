...
const updateDivisions = callback => {
	request('https://docs.google.com/spreadsheets/d/e/2PACX-1vSVgu8-VsBDVqWNcQreom4ggkxjSorRKd-PczxOOucccM1r_SdlQl-zl0DjUZIZ6Zdu-bCYVGEzeMEr/pub?gid=0&single=true&output=csv', (error, response, body) => {
